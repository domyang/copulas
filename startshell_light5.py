...
list_models=[cop.gaussian,cop.student]
list_models.extend([lambda x: vines.D_vine(x,list_models=[[i],[cop_all]]) for i in list2])
list_models.extend([lambda x: vines.D_vine(x,list_models=[[i],[un]]) for i in list2])
